  ...
  return (
    <div className="space-y-6">
      ...
      {!hasData && (
        <Section title="Get Started">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link
              to="/upload"
              className="p-6 rounded-2xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-500/20 hover:border-blue-500/40 transition-all group"
            >
              ...
              <p className="text-sm text-slate-400">
                Upload your Webull Orders CSV to calculate risk
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-sm text-slate-400">
                Set your starting equity and preferences
              </p>
            </Link>
            ...
            <div className="p-6 rounded-2xl bg-white/[0.02] border border-white/10">
              ...
              <p className="text-sm text-slate-400">
                Understand how the Restart Throttle strategy works
              </p>
            </div>
          </div>
        </Section>
      ...
      {hasData && (
        ...
        >
          {/* This will be filled in Step 2 with actual TradesTable */}
