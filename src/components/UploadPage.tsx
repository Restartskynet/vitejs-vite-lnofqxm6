...
export function UploadPage() {
  return (
    <Page
      title="Import Trades"
      subtitle="Upload your Webull Orders CSV to calculate risk"
    >
      <Section>
        <Card>
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-bold text-white mb-2">
              Upload Module Coming in Step 2
            </h3>
            <p className="text-sm text-slate-400 max-w-md mx-auto">
              This will include drag & drop upload, CSV validation, preview table,
              and real integration with the Webull Orders importer.
            </p>
          </div>
        </Card>
      </Section>
